                ...
                <div class="home-page">
                    ...
                    <section class="hero-section d-flex align-items-stretch" style="min-height: 500px;">
                        <div class="hero-left position-relative flex-grow-1" style="flex-basis:60%; min-width:0;">
                            <video class="hero-video-bg" src="{{ home_url('/') }}/content/uploads/Home.mp4" autoplay loop muted playsinline style="object-fit:cover; width:auto; height:100%;"></video>
                        ...
                        <div class="hero-right d-flex flex-column justify-content-center align-items-start p-5" style="flex-basis:40%; background:#0f1b2a; position:relative; min-width:0;">
                            ...
                            <a href="" class="btn btn-primary mb-4 hero-btn">Contact us</a>
                        ...
                        <div class="container">
                            <div class="row align-items-center mb-4">
                                ...
                                <div class="col-12 col-md-12 text-md-end mt-3 mt-md-0">
                                    <a href="#" class="btn btn-primary btn-lg">Conocer más</a>
                                </div>
                            </div>
                    ...
                    <section class="Clientes-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col clientes-logos d-flex flex-wrap justify-content-center align-items-center gap-4 mt-4">
                                <img src="{{ home_url('/') }}/content/uploads/EOS.svg" alt="Cliente 1" class="cliente-logo">
                                
                                <img src="{{ home_url('/') }}/content/uploads/OSS.svg" alt="Cliente 3" class="cliente-logo">
                                <img src="{{ home_url('/') }}/content/uploads/R.svg" alt="Cliente 4" class="cliente-logo">
                                <img src="{{ home_url('/') }}/content/uploads/Azumi.svg" alt="Cliente 5" class="cliente-logo">
                                <img src="{{ home_url('/') }}/content/uploads/SeaRates.svg" alt="Cliente 6" class="cliente-logo">
                            </div>
                        </div>
                        </div>
                    </section>
