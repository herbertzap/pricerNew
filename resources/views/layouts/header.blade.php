                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <div class="d-flex align-items-center ms-lg-3 header-social-icons">
                            <a href="https://facebook.com/" target="_blank" aria-label="Facebook" class="btn btn-link p-0 me-2 social-icon">
                                <!-- Facebook SVG -->
                            ...
                            <a href="https://instagram.com/" target="_blank" aria-label="Instagram" class="btn btn-link p-0 me-2 social-icon">
                                <!-- Instagram SVG -->
                            ...
                            <a href="https://linkedin.com/" target="_blank" aria-label="LinkedIn" class="btn btn-link p-0 me-2 social-icon">
                                <!-- LinkedIn SVG -->
